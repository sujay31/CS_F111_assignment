...
16. If the user enters s(case insensitive), he/she will be asked for the name of file that has to be resaved.
...
19. If the user enters f(case insensitive), he/she will be asked for a word/pattern to be searched(max length is 25).
...
#############################################################
The code was developed as a team project with PRANAV KUMAR and VIPUL VIVEK WALUNJ.
#############################################################
